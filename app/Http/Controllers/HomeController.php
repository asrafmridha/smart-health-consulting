...
class HomeController extends Controller
{
    ...
    function contact(Request $req)
    {
        ...
        return redirect()->back()->with('message', "Thank you for your Complain  ");
    }
    ...
    function deletecomplain($id){
     ...
     return redirect()->back()->with('message', "Complain delete Successfully");
