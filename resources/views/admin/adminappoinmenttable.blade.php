        ...
        <table style="margin-top: 100px ">
            <tr  >
              ...
              <th style="padding: 10px ; font-size :20px">Address</th>
                ...
                <th style="padding: 10px ; font-size :20px">Accept</th>
            ...
            <tr style="background-color:black; color:white" >
              ...
              <td style="padding: 10px ; font-size :20px">{{$item->address}}</td>
    
                <td style="padding: 10px ; font-size :20px">{{$item->doctor}}</td>
    
                <td style="padding: 10px ; font-size :20px">{{$item['date']}}</td>
